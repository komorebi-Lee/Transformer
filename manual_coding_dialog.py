        ...
        try:
            ...
            if found_count == 0 and not has_valid_sentence_id and sentences_to_highlight:
                ...
                for sentence_info in sentences_to_highlight:
                    ...
                    if re.search(r'^说话人\d+$', sentence_clean) or re.search(r'^(受访者|采访者|被访者|主持人|采访员|提问者)$', sentence_clean):
            ...
            if found_count == 0 and not has_valid_sentence_id and code_clean:
                # 关键修复：跳过说话人标签的内容匹配
                if re.search(r'^说话人\d+$', code_clean) or re.search(r'^(受访者|采访者|被访者|主持人|采访员|提问者)$', code_clean):
