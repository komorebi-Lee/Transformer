...
class ProjectManager:
    ...
    def save_project(self, project_name: str, loaded_files: Dict[str, Any], structured_codes: Dict[str, Any]) -> bool:
        ...
        try:
            # 创建项目文件夹
            project_dir = os.path.join(self.project_base_dir, project_name)
    ...
    def get_projects_list(self) -> list:
        ...
        if os.path.exists(self.project_base_dir):
            for item in os.listdir(self.project_base_dir):
                item_path = os.path.join(self.project_base_dir, item)
